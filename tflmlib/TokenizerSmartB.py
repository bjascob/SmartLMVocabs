...
# This is the same as SmartA except there is no NER used here at all but
# NNP (proper nouns) and numbers (CD) as classified as such via POS
class TokenizerSmartB(Tokenizer):
    def __init__(self, dict_fn):
        super(TokenizerSmartB, self).__init__()
    ...
    def tokenizeSentence(self, sent):
        ...
        while i < sent_len:
            ...
            if sent['pos'][i].startswith('NNP') or sent['pos'][i] == 'CD' \
